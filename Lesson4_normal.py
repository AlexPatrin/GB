...
print('Имя не с заглавной буквы' if re.match(pattern, name) is None else name)
surname = input('введите Фамилию: ')
print('фамилия введена не с заглавной буквы' if re.match(pattern, surname) is None else surname)
email = input('введите email: ')
epattern = '[a-z_0-9^A-Z]+@[a-z0-9]+\.(ru|com|org)'
print('неверно введен email' if re.match(epattern, email) is None else email)
...
print('-------------Task 2')
pattern3 = '[.]{2,}'
print('совпадений не найдено' if re.search(pattern3, some_str) is None else 'совпадение .. найдено')
